...
namespace OpenRA.Mods.Yupgi_alert.Activities
{
	public class SpawnedFlyAttack : Activity
	{
		...
		public SpawnedFlyAttack(Actor self, Target target)
		{
			...
			attackAircraft = self.TraitOrDefault<AttackAircraft>();
		...
		public override Activity Tick(Actor self)
		{
			...
			if (ChildActivity == null)
			{
				...
				if (attackAircraft != null && target.IsInRange(self.CenterPosition, attackAircraft.Armaments.Select(a => a.Weapon.MinRange).Min()))
