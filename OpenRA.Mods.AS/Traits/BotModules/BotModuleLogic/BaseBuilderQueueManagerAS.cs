...
{
	class BaseBuilderQueueManagerAS
	{
		readonly string category;

		readonly BaseBuilderBotASModule baseBuilder;
		...
		public BaseBuilderQueueManagerAS(BaseBuilderBotASModule baseBuilder, string category, Player p, PowerManager pm,
