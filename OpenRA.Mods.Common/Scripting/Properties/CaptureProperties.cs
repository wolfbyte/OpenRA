...
namespace OpenRA.Mods.Common.Scripting
{
	...
	public class CaptureProperties : ScriptActorProperties
	{
		...
		public void Capture(Actor target)
		{
			...
			{
				if (captures.Any(x => !x.IsTraitDisabled && x.Info.CaptureTypes.Overlaps(activeCapturable.Info.Types)))
				{
			...
			{
				if (externalCaptures.Any(x => !x.IsTraitDisabled && x.Info.CaptureTypes.Overlaps(externalCapturable.Types)))
				{
